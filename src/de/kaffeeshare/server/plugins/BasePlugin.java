 ...
 * 
 * A plugin has to implement the "match" method to select the urls handled by
 * the plugin. Specialized outputs are generated by overriding the methods.
 */
public abstract class BasePlugin {

	protected static final Logger log = Logger.getLogger(BasePlugin.class
			.getName());
	...
	public Item createItem(URL url) {
		...
		return DatastoreManager.getDatastore().createItem(caption, urlString,
	...
	protected String getProperty(Document doc, String prop) {
		String caption;
		caption = doc.getElementsByAttributeValue("property", prop).first()
				.attr("content");
		return caption;
	}
